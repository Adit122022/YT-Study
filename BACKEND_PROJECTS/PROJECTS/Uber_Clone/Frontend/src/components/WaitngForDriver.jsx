...
const WaitngForDriver = ({setWaitingForDriver , waitingForDriver}) => {
  ...
  useGSAP(
    ...
    [waitingForDriver])
  return (
  <div ref={waitingForDriverRef} className="fixed bottom-0 w-full translate-y-full  bg-white  rounded-t-lg px-3 py-6 shadow-md z-50" >
        <div className="mb-5 flex justify-start pl-1">
          <h5 onClick={()=>{ setWaitingForDriver(false)}} className="absolute top-6 right-6 text-2xl font-bold " >
        ...
        <div className='flex justify-between  w-full'> 
          ...
          <div className=' w-full text-right'>
           <h2 className='text-base font-medium text-gray-800 font-serif'>Sarthak</h2>
           <h4 className='text-lg font-semibold font-mono -my-1 text-slate-800'>MP04 AB 1234</h4>
